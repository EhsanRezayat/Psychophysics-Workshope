...
imformat = 'tif';
path_= cd; 
input_folder = fullfile(path_,'sup','SHINEtoolbox','SHINE_INPUT');
output_folder = fullfile(path_,'sup','SHINEtoolbox','SHINE_OUTPUT');
template_folder = fullfile(path_,'sup','SHINEtoolbox','SHINE_TEMPLATE');
